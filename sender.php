...
define("CONTROL_DIR",ROOT_PATH."module/{$module}/source/sender");
define("MODEL_DIR",ROOT_PATH."source/model");
define("HOOK_DIR","module/{$module}/source/hook");
/*视图模版配置*/
$cache_dir="";//模版缓存文件夹
$template_dir="module/".$module."/themes/sender";//模版风格文件夹
$wap_template_dir="module/".$module."/themes/sender";//模版风格文件夹
...
//判断是否在公众号
if(isset($_GET['fromapp']) && $_GET['fromapp']=="uniapp" ){
	define("INWEIXIN",0);
